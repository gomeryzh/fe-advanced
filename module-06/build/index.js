...
var Hamburger = function () {
  ...
  _createClass(Hamburger, [{
    ...
    value: function addTopping(topping) {
      var hasTopping = this.toppings.find(function (key) {
        return key === topping;
      });
      if (hasTopping) {
    ...
    value: function removeTopping(topping) {
      this.toppings = this.toppings.filter(function (value) {
    ...
    value: function calculatePrice() {
      ...
      var stuffingPrice = Hamburger.STUFFINGS[this.stuffing].price;
      var getTotalToppingsPrice = this.toppings.reduce(function (acc, value) {
        return acc + Hamburger.TOPPINGS[value].price;
      }, 0);
      var totalPrice = sizePrice + stuffingPrice + getTotalToppingsPrice;
      return totalPrice;
    }
  }, {
    ...
    value: function calculateCalories() {
      ...
      var stuffingCalories = Hamburger.STUFFINGS[this.stuffing].calories;
      var getTotalToppingsCalories = this.toppings.reduce(function (acc, value) {
        return acc + Hamburger.TOPPINGS[value].calories;
      }, 0);
      var totalCalories = sizeCalories + stuffingCalories + getTotalToppingsCalories;
